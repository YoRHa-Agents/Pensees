...
| Curl install fails with exit 5 | The latest-release API lookup failed (rate-limited or transient) | Retry, or pin `PENSEES_VERSION=v0.3.2` to skip the API call |
